...
async def generate_spelling_problems(count: int, grade: int, settings: GermanSettings) -> List[GermanProblem]:
    ...
    grade2_words = [
        ...
        {"correct": "Blume", "wrong": ["Bluhme", "Bluume", "Bluhm"]},
        {"correct": "Sonne", "wrong": ["Sone", "Sonnne", "Sohne"]},
        {"correct": "Mond", "wrong": ["Mont", "Mohnd", "Mondt"]},
        {"correct": "Stern", "wrong": ["Schtern", "Sdern", "Sterrn"]},
        {"correct": "Wasser", "wrong": ["Waser", "Wasserr", "Waßer"]},
        {"correct": "Feuer", "wrong": ["Feur", "Feuerr", "Foier"]},
        ...
        {"correct": "Gurke", "wrong": ["Gurke", "Guhrke", "Kuhrke"]},
        ...
        {"correct": "Zucker", "wrong": ["Zuker", "Zukker", "Sucker"]},
        {"correct": "Salz", "wrong": ["Salzz", "Sahlz", "Zals"]},
        {"correct": "Pfeffer", "wrong": ["Pfefferr", "Phefer", "Pfeffher"]},
        {"correct": "Messer", "wrong": ["Meser", "Messerr", "Meßer"]},
        {"correct": "Gabel", "wrong": ["Gabbel", "Gaabel", "Kaabel"]},
        {"correct": "Löffel", "wrong": ["Löfel", "Löfell", "Löhffel"]},
        {"correct": "Teller", "wrong": ["Teler", "Tellerr", "Deller"]},
        {"correct": "Tasse", "wrong": ["Tase", "Tassse", "Tahsse"]},
        {"correct": "Glas", "wrong": ["Glass", "Glahs", "Klahs"]},
        {"correct": "Flasche", "wrong": ["Flaschhe", "Flahsche", "Vlasche"]},
        {"correct": "Schüssel", "wrong": ["Schüsel", "Schüssell", "Schühssel"]},
        {"correct": "Topf", "wrong": ["Tohpf", "Toppf", "Dopf"]},
        {"correct": "Pfanne", "wrong": ["Pfane", "Pfannne", "Phanne"]},
        {"correct": "Ofen", "wrong": ["Ohfen", "Offen", "Ofenn"]},
        ...
        {"correct": "Toilette", "wrong": ["Toilete", "Toilette", "Doilette"]},
        {"correct": "Fenster", "wrong": ["Fensder", "Fensterr", "Vensder"]},
        {"correct": "Tür", "wrong": ["Tühr", "Tür", "Dühr"]},
        {"correct": "Wand", "wrong": ["Wannt", "Waand", "Vand"]},
        {"correct": "Boden", "wrong": ["Bohden", "Bodden", "Pooden"]},
        {"correct": "Decke", "wrong": ["Deke", "Deckke", "Degge"]},
        {"correct": "Lampe", "wrong": ["Lamphe", "Lahmpe", "Lampee"]},
        {"correct": "Sofa", "wrong": ["Soffa", "Sohfa", "Zofa"]},
        {"correct": "Sessel", "wrong": ["Sesel", "Sessell", "Zessel"]},
        {"correct": "Bett", "wrong": ["Bet", "Bettt", "Peht"]},
        {"correct": "Kissen", "wrong": ["Kisen", "Kissenn", "Gissen"]},
        {"correct": "Decke", "wrong": ["Deke", "Deckke", "Degge"]},
        {"correct": "Schrank", "wrong": ["Schrangk", "Schrankk", "Srank"]},
        {"correct": "Regal", "wrong": ["Regahl", "Regall", "Rekahl"]},
        {"correct": "Spiegel", "wrong": ["Spiegell", "Spieegel", "Zbiekel"]},
        {"correct": "Uhr", "wrong": ["Uhhr", "Uhrr", "Ohr"]},
        {"correct": "Radio", "wrong": ["Raddio", "Rahddio", "Radjo"]},
        {"correct": "Computer", "wrong": ["Komputer", "Computher", "Gomputer"]},
        {"correct": "Handy", "wrong": ["Hanndy", "Handhy", "Hanty"]},
        {"correct": "Telefon", "wrong": ["Telefohn", "Telephon", "Delefon"]},
        {"correct": "Fahrrad", "wrong": ["Farrad", "Fahrraad", "Vahrrat"]},
        {"correct": "Roller", "wrong": ["Roler", "Rollerr", "Rohller"]},
        {"correct": "Spielzeug", "wrong": ["Spielszeug", "Spielzeuhg", "Zbielzeug"]},
        {"correct": "Puppe", "wrong": ["Pupe", "Puppee", "Buppe"]},
        {"correct": "Teddy", "wrong": ["Tedy", "Teddhy", "Dehdy"]},
        {"correct": "Legosteine", "wrong": ["Legohsteine", "Legosteine", "Lekosteine"]},
        {"correct": "Puzzle", "wrong": ["Puzel", "Puzzlle", "Bussle"]},
        {"correct": "Malen", "wrong": ["Mahlen", "Mallenn", "Maalen"]},
        {"correct": "Zeichnen", "wrong": ["Zeichnenn", "Seichnen", "Zeihchnen"]},
        {"correct": "Basteln", "wrong": ["Bastelnn", "Basdeln", "Pasteln"]},
        {"correct": "Spielen", "wrong": ["Spielenn", "Sbielenn", "Spiellen"]},
        {"correct": "Lachen", "wrong": ["Lachenn", "Lahchenn", "Lachhen"]},
        {"correct": "Weinen", "wrong": ["Weinenn", "Weihnen", "Veinen"]},
        {"correct": "Schlafen", "wrong": ["Schlafenn", "Schlaafenn", "Schlafen"]},
        {"correct": "Essen", "wrong": ["Esenn", "Eßen", "Ehssen"]},
        {"correct": "Trinken", "wrong": ["Trinkenn", "Drinken", "Trinken"]},
        {"correct": "Laufen", "wrong": ["Laufenn", "Lauhfen", "Laaufen"]},
        {"correct": "Springen", "wrong": ["Springenn", "Zbringen", "Springgen"]},
        {"correct": "Hüpfen", "wrong": ["Hüpfenn", "Hühpfen", "Hübbfen"]},
        {"correct": "Tanzen", "wrong": ["Tansenn", "Danzen", "Tahntzen"]},
        {"correct": "Singen", "wrong": ["Singenn", "Zingen", "Sinngen"]},
        {"correct": "Hören", "wrong": ["Hörenn", "Höhren", "Gehören"]},
        {"correct": "Sehen", "wrong": ["Sehenn", "Zehen", "Seehen"]},
        {"correct": "Riechen", "wrong": ["Riechenn", "Riechen", "Riehchen"]},
        {"correct": "Schmecken", "wrong": ["Schmekenn", "Schmeggen", "Schmecken"]},
        {"correct": "Fühlen", "wrong": ["Fühlenn", "Vühlen", "Füühlen"]},
        {"correct": "Denken", "wrong": ["Denkenn", "Dhenken", "Thenken"]},
        {"correct": "Lernen", "wrong": ["Lernenn", "Lehrnenn", "Leernen"]},
        {"correct": "Verstehen", "wrong": ["Verstehenn", "Verschtehen", "Vehrstehen"]},
        {"correct": "Sprechen", "wrong": ["Sprechenn", "Zbrechenn", "Sprehchen"]},
        {"correct": "Fragen", "wrong": ["Fragenn", "Vragenn", "Fraagen"]},
        {"correct": "Antworten", "wrong": ["Antwohrtenn", "Andworten", "Antwortenn"]},
        {"correct": "Helfen", "wrong": ["Helfenn", "Helffenn", "Gehlfen"]},
        {"correct": "Danke", "wrong": ["Dankhe", "Dahnke", "Tankhe"]},
        {"correct": "Bitte", "wrong": ["Bite", "Bittee", "Pitee"]}
    ]
    ...
    grade3_words = [
        ...
        {"correct": "Gymnasium", "wrong": ["Gimnasium", "Gymnasiuhm", "Kymnasium"]},
        {"correct": "Bibliothek", "wrong": ["Bibliotheg", "Biblioteek", "Pibliothek"]},
        {"correct": "Krankenhaus", "wrong": ["Krankenhauß", "Krankenhous", "Grankenhaus"]},
        {"correct": "Polizei", "wrong": ["Polizai", "Politzei", "Bolizei"]},
        {"correct": "Feuerwehr", "wrong": ["Feuerwer", "Feuervehr", "Veuerwehr"]},
        {"correct": "Bahnhof", "wrong": ["Banhhof", "Bahhof", "Pahnhof"]},
        {"correct": "Flughafen", "wrong": ["Flughaafen", "Flughaffen", "Vlughafen"]},
        {"correct": "Restaurant", "wrong": ["Restorannt", "Restaurantt", "Restarannt"]},
        {"correct": "Supermarkt", "wrong": ["Subermarkt", "Supermarckt", "Zupermarkt"]},
        {"correct": "Apotheke", "wrong": ["Apoteke", "Apothekee", "Abotheke"]},
        {"correct": "Bäckerei", "wrong": ["Bäckerai", "Bäckerey", "Pägkerei"]},
        {"correct": "Metzgerei", "wrong": ["Mezgerei", "Metzgerey", "Metzkerrei"]},
        {"correct": "Friseur", "wrong": ["Frisör", "Friseuer", "Vriseur"]},
        {"correct": "Zahnarzt", "wrong": ["Zahnahrzt", "Sahnarszt", "Zahnarrzt"]},
        {"correct": "Krankenhaus", "wrong": ["Grankenhauß", "Krankenhous", "Krangenhaus"]},
        {"correct": "Drogerie", "wrong": ["Drogirie", "Drogeriee", "Throgerie"]},
        {"correct": "Tankstelle", "wrong": ["Dangstelle", "Tankstele", "Tangkstelle"]},
        {"correct": "Parkplatz", "wrong": ["Bargplatz", "Parkblatz", "Pahrkplatz"]},
        {"correct": "Schwimmbad", "wrong": ["Schwimbaad", "Schwimbadd", "Schwimmpat"]},
        {"correct": "Turnhalle", "wrong": ["Turnhale", "Turnhallee", "Durnhalle"]},
        {"correct": "Sportplatz", "wrong": ["Sbortplatz", "Sportblatz", "Zportplatz"]},
        {"correct": "Kino", "wrong": ["Kinno", "Gieno", "Kinoh"]},
        {"correct": "Theater", "wrong": ["Theather", "Theaterr", "Deater"]},
        {"correct": "Museum", "wrong": ["Musuem", "Museuhm", "Muhseum"]},
        {"correct": "Konzert", "wrong": ["Konsert", "Konzehrt", "Gonsert"]},
        {"correct": "Geburtstag", "wrong": ["Geburdstag", "Geburstag", "Keburtstag"]},
        {"correct": "Hochzeit", "wrong": ["Hochseit", "Hochtzeit", "Gochzeit"]},
        {"correct": "Weihnachten", "wrong": ["Weihnachden", "Waynachten", "Weihnachtenn"]},
        {"correct": "Ostern", "wrong": ["Osdtern", "Ohstern", "Osthern"]},
        {"correct": "Neujahr", "wrong": ["Neujar", "Neuhjar", "Naujahr"]},
        {"correct": "Silvester", "wrong": ["Silveshter", "Silvesther", "Zilvester"]},
        {"correct": "Fasching", "wrong": ["Vaschihng", "Faschingg", "Faschink"]},
        {"correct": "Pfingsten", "wrong": ["Bfingsten", "Pfingsdten", "Pfingshten"]},
        {"correct": "Himmelfahrt", "wrong": ["Himelfart", "Himmelfahrdt", "Himmmelfahrt"]},
        {"correct": "Erntedankfest", "wrong": ["Erntedangfest", "Erntedankfehst", "Erntethankfest"]},
        {"correct": "Valentinstag", "wrong": ["Valentinsdtag", "Valendinsstag", "Valendinstag"]},
        {"correct": "Muttertag", "wrong": ["Mutertag", "Mutthertag", "Mudtertag"]},
        {"correct": "Vatertag", "wrong": ["Vadertag", "Vathertag", "Vatertahg"]},
        {"correct": "Kindertag", "wrong": ["Gindertag", "Kindhertag", "Kinntertag"]},
        {"correct": "Schulanfang", "wrong": ["Schulahnfang", "Schulannfang", "Zchulannfang"]},
        {"correct": "Ferien", "wrong": ["Verienn", "Ferienn", "Ferien"]},
        {"correct": "Urlaub", "wrong": ["Urlauhb", "Uhrlaub", "Urlaaub"]},
        {"correct": "Abenteuer", "wrong": ["Abenteur", "Abendteuer", "Apendteuer"]},
        {"correct": "Überraschung", "wrong": ["Übraschung", "Überraschuhng", "Überrraschung"]},
        {"correct": "Entschuldigung", "wrong": ["Entschuhldigung", "Entschuldigungg", "Entschultigung"]},
        {"correct": "Glückwunsch", "wrong": ["Glükwunsch", "Glückwuhnsch", "Klückwunsch"]},
        {"correct": "Geburtstag", "wrong": ["Geburdstag", "Geburstag", "Keburtstag"]},
        {"correct": "Einladung", "wrong": ["Einladuung", "Ainladung", "Einladhung"]},
        {"correct": "Geschenk", "wrong": ["Keschenk", "Geschengk", "Gescghenk"]},
        {"correct": "Überraschung", "wrong": ["Übraschung", "Überraschuhng", "Übberraschung"]},
        {"correct": "Vergnügen", "wrong": ["Verknügen", "Vergnühgen", "Verkgnügen"]},
        {"correct": "Abenteuer", "wrong": ["Abendteuer", "Abenteur", "Apenteur"]},
        {"correct": "Spaziergang", "wrong": ["Sbasiergang", "Spazierkangg", "Spaziergank"]},
        {"correct": "Ausflug", "wrong": ["Ausfluk", "Ausflugg", "Ahusflug"]},
        {"correct": "Picknick", "wrong": ["Biknik", "Picknik", "Pigknick"]},
        {"correct": "Campingplatz", "wrong": ["Gambingplatz", "Campinkplatz", "Campingblatz"]},
        {"correct": "Wanderung", "wrong": ["Vanderung", "Wanderungg", "Wahndehrung"]},
        {"correct": "Bergtour", "wrong": ["Pergtour", "Bergdour", "Berktour"]},
        {"correct": "Skifahren", "wrong": ["Sgifahren", "Skifaren", "Zkifahren"]},
        {"correct": "Schwimmen", "wrong": ["Schwimen", "Schwimmenn", "Schwimmmen"]},
        {"correct": "Tauchen", "wrong": ["Dauhchen", "Tauchenn", "Daucgen"]},
        {"correct": "Segeln", "wrong": ["Zegeln", "Sehgeln", "Segellnn"]},
        {"correct": "Rudern", "wrong": ["Ruhdern", "Rudehrn", "Rudhern"]},
        {"correct": "Angeln", "wrong": ["Ahngeln", "Angelnn", "Ankeln"]},
        {"correct": "Reiten", "wrong": ["Raiten", "Reitenn", "Reihten"]},
        {"correct": "Klettern", "wrong": ["Glettern", "Kletehrn", "Kletttern"]},
        {"correct": "Fahrradfahren", "wrong": ["Faradfahren", "Fahrradfarren", "Varradfahren"]},
        {"correct": "Inlineskaten", "wrong": ["Inlaineskaten", "Inlineskahten", "Inlinezgaten"]},
        {"correct": "Skateboard", "wrong": ["Sgeateboard", "Skateborrd", "Skatepoard"]},
        {"correct": "Rollschuhe", "wrong": ["Rolschuhe", "Rollschue", "Rohlschuhe"]},
        {"correct": "Basketball", "wrong": ["Pasketball", "Basketbal", "Basgedball"]},
        {"correct": "Fußball", "wrong": ["Vußball", "Fußbal", "Fuhßball"]},
        {"correct": "Volleyball", "wrong": ["Voleyball", "Volleybal", "Voleiball"]},
        {"correct": "Handball", "wrong": ["Handbahl", "Handbal", "Gantball"]},
        {"correct": "Tennis", "wrong": ["Denis", "Tenis", "Tehhnis"]},
        {"correct": "Badminton", "wrong": ["Padminton", "Badmintohn", "Batminton"]},
        {"correct": "Tischtennis", "wrong": ["Dischtennis", "Tischenis", "Tischtenhis"]},
        {"correct": "Gymnastik", "wrong": ["Kymnastik", "Gymnastig", "Gymnashtig"]},
        {"correct": "Turnen", "wrong": ["Duhrnen", "Turnenn", "Turnnenn"]},
        {"correct": "Tanzen", "wrong": ["Dahntzen", "Tanzenn", "Danzen"]},
        {"correct": "Ballett", "wrong": ["Balet", "Balettt", "Pallett"]},
        {"correct": "Musik", "wrong": ["Muhsik", "Muzik", "Muusik"]},
        {"correct": "Klavier", "wrong": ["Glavier", "Klaviehr", "Klahvier"]},
        {"correct": "Gitarre", "wrong": ["Kitarre", "Gitare", "Gitahre"]},
        {"correct": "Geige", "wrong": ["Kaige", "Geihe", "Geiege"]},
        {"correct": "Flöte", "wrong": ["Vlöte", "Flöhte", "Flötte"]},
        {"correct": "Trompete", "wrong": ["Drompete", "Trombete", "Trompehte"]},
        {"correct": "Schlagzeug", "wrong": ["Schlagseug", "Schlagzeugg", "Schlagszeug"]},
        {"correct": "Chor", "wrong": ["Khor", "Chohr", "Cchor"]},
        {"correct": "Orchester", "wrong": ["Orcheshter", "Orgeschter", "Orkester"]},
        {"correct": "Konzert", "wrong": ["Gonsert", "Konsert", "Konzehrt"]},
        {"correct": "Dirigent", "wrong": ["Dirikent", "Dirigehnt", "Thrigent"]}
    ]
