              ...
              <div className="flex items-center space-x-3">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const numericValue = value === '' ? 15 : parseInt(value);
                    console.log('🔍 DEBUG: English input changed - name:', name, 'value:', value, 'numeric:', numericValue);
                    ...
                    setSettings(prevSettings => {
                      ...
                      console.log('🔍 DEBUG: English previous settings state:', JSON.stringify(prevSettings, null, 2));
                      console.log('🔍 DEBUG: English updated settings state:', JSON.stringify(updatedSettings, null, 2));
                    ...
                    <label key={type} className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          console.log(`🔍 DEBUG: English problem type '${type}' changed to:`, isChecked);
                          ...
                          setSettings(prevSettings => {
                            ...
                            console.log('🔍 DEBUG: New English settings with problem type update:', JSON.stringify(newSettings, null, 2));
                            return newSettings;
                          });
                        }}
...
const GermanSettingsModal = ({ isOpen, onClose, onComplete }) => {
  ...
  const updateStarTier = (percentage, stars) => {
    setSettings(prevSettings => {
      ...
      newTiers[percentage] = stars;
      const newSettings = { ...prevSettings, star_tiers: newTiers };
      console.log('🔍 DEBUG: German star tier updated:', JSON.stringify(newSettings, null, 2));
      return newSettings;
    });
  };
  ...
  const removeStarTier = (percentage) => {
    setSettings(prevSettings => {
      ...
      delete newTiers[percentage];
      const newSettings = { ...prevSettings, star_tiers: newTiers };
      console.log('🔍 DEBUG: German star tier removed:', JSON.stringify(newSettings, null, 2));
      return newSettings;
    });
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-white rounded-xl p-8 max-w-4xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto">
        ...
        {(loading || !settings) && (
          <div className="flex justify-center items-center py-8">
            <div className="text-blue-600">Laden...</div>
          </div>
        )}
...
const MathSettingsModal = ({ isOpen, onClose, onComplete }) => {
  ...
  const updateStarTier = (percentage, stars) => {
    setSettings(prevSettings => {
      ...
      newTiers[percentage] = stars;
      const newSettings = { ...prevSettings, star_tiers: newTiers };
      console.log('🔍 DEBUG: Math star tier updated:', JSON.stringify(newSettings, null, 2));
      return newSettings;
    });
  };
  ...
  const removeStarTier = (percentage) => {
    setSettings(prevSettings => {
      ...
      delete newTiers[percentage];
      const newSettings = { ...prevSettings, star_tiers: newTiers };
      console.log('🔍 DEBUG: Math star tier removed:', JSON.stringify(newSettings, null, 2));
      return newSettings;
    });
  };
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const { name, value } = e.target;
                    const numericValue = value === '' ? 15 : parseInt(value);
                    console.log('🔍 DEBUG: Input changed - name:', name, 'value:', value, 'numeric:', numericValue);
                    ...
                    setSettings(prevSettings => {
                      ...
                      console.log('🔍 DEBUG: Previous settings state:', JSON.stringify(prevSettings, null, 2));
                      console.log('🔍 DEBUG: Updated settings state:', JSON.stringify(updatedSettings, null, 2));
                      return updatedSettings;
                    });
                  }}
